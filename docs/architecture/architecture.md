...
| 15 | non-functional-requirements | [15-non-functional-requirements.md](design/15-non-functional-requirements.md) | 유휴 시 워커 0까지 축소 규칙·설정·관측 | 축소 루프, `PoolConfig` | [idle-scale-to-zero](../spec/2026-09-18-spec-idle-scale-to-zero/2026-09-18-spec-idle-scale-to-zero.md) | 미반영 |
